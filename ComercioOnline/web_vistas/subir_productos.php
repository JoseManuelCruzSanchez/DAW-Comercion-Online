...
if($_SESSION['admin'] == true){
    if(isset($_POST['referencia'])){
        if($_POST['referencia'] == '' || $_POST['titulo'] == '' || $_POST['descripcion'] == '' || $_POST['precio'] == ''){
            ...
            $archivo = (isset($_FILES['ruta_imagen'])) ? $_FILES['ruta_imagen'] : null;
            if ($archivo) {
                $ruta_destino_archivo_para_BBDD = "imagenes/$referencia/{$archivo['name']}";
                $ruta_destino_archivo = "../imagenes/$referencia/{$archivo['name']}";
                $archivo_ok = move_uploaded_file($archivo['tmp_name'], $ruta_destino_archivo);
            }
            guardarProductoBBDD($_POST['referencia'],$_POST['titulo'],$_POST['descripcion'], $ruta_destino_archivo_para_BBDD, $_POST['precio']);
