<?php
    ...
    if(isset($_POST['nick']) && isset($_POST['contrasena']) && isset($_POST['nombre']) && isset($_POST['apellidos']) &&
        ...
        if($_POST['nick'] == '' || $_POST['contrasena'] == '' || $_POST['nombre'] == '' || $_POST['apellidos'] == '' ||
            ...
            mostrarFormulario('nuevo_usuario.php', 'Registrarse', false, $_POST['nick'], $_POST['contrasena'], $_POST['confirmar'], $_POST['nombre'], $_POST['apellidos'], $_POST['telefono'], $_POST['direccion'], '');
        ...
        mostrarFormulario('nuevo_usuario.php', 'Registrarse', false,"", "", "", "", "", "", "", '');
    }
?>
